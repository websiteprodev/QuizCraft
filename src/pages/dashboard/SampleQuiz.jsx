    ...
    return (
        <div className="p-6">
            <Card className="p-6">
                ...
                <Typography variant="paragraph" className="mb-4">{sampleQuestions[currentQuestionIndex].text}</Typography>
                {sampleQuestions[currentQuestionIndex].answers.map((answer, index) => (
                    <label key={index} className="flex items-center mb-2">
                        <input
                            ...
                            className="mr-2 h-5 w-5 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 focus:ring-2"
                        />
                ...
                <Button
                    variant="gradient"
                    color="blue"
                    className="mt-4 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
