                                ...
                                <NavLink to={`/${layout}${path}`}>
                                    {({ isActive }) => (
                                        <Button
                                            ...
                                            className="flex items-center gap-4 px-4 py-2 rounded-lg transition-all duration-300 hover:bg-yellow-600 hover:text-white capitalize"
                                            fullWidth
                                        >
                                            {icon}
                                            <Typography
